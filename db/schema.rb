...
ActiveRecord::Schema.define(version: 20150609024718) do
  ...
  add_index "stand_ups", ["work_group_id"], name: "index_stand_ups_on_work_group_id"
  ...
  add_index "users", ["work_group_id"], name: "index_users_on_work_group_id"
